    ...
    <>
      ...
      {cartItemsLen == 0 ? (
        <div className="h-[100vh]">
          <center>
            <p className=" text-[20px] font-bold mt-[300px]">
              Cart is empty.😒
            </p>
          </center>
        </div>
          ...
          <div className="w-[40%] flex items-start pt-20">
            <div className="w-[70%] mx-auto bg-white shadow-md border border-blue-300 rounded-md p-6">
              ...
              <button
                ...
                className="w-full border border-blue-700 text-blue-700 py-2 bg-white font-semibold hover:bg-blue-700 hover:text-white transition-colors rounded"
              >
                Proceed to Checkout
              </button>
            </div>
