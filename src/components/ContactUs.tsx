...
const ContactUs:React.FC = () => {
  ...
  <div className='mt-4'>
    ...
    <input type="text" className=" border border-black rounded px-3 py-2 outline-none" />
  </div>
  ...
  <div>
    ...
    <input type="email" className=" border border-black rounded px-3 py-2 outline-none" />
  </div>
  ...
  <div>
    <button type="submit" className="bg-blue-400 text-white px-5 py-3 rounded-full  hover:bg-blue-600">
      Send msg
    </button>
  </div>
</form>
    ...
    <div className=' bg-blue-400    p-6 max-h-max rounded-lg'>
        ...
        <div className=' justify-center '>
            <div >
                <p className='text-white text-xs ml-3 p-2'>We love to hear from you.Our friendly team is always here to chat</p>
                <div className='p-5'>
                <h1 className='font-semibold'><FontAwesomeIcon icon={faHouse} />Address</h1>
                <p className='ml-2'>123 Main Street, City, Country</p>
                </div>
                <div className='p-4'>
                    <h1 className='font-semibold'><FontAwesomeIcon icon={faPhone} />Phone</h1>
                    <p className='ml-2'>+91 1233344566</p>
                </div>
                <div className='p-4'>
                    <h1 className='font-semibold'><FontAwesomeIcon icon={faEnvelope} />Email</h1>
