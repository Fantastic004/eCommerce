      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden">
        ...
        <div>
          <div className="absolute inset-0 bg-opacity-50 flex flex-col bottom-[200px] left-[100px] justify-center">
            <h4 className="text-4xl text-blue-400 md:text-6xl font-bold mb-4">
              ABOUT US
            </h4>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col justify-center ">
              ...
              <p className="mb-4">
                ...
                consectetur, adipisicing elit. Hic, nostrum! Quasi debitis velit
                aliquam culpa unde similique, illum minus cupiditate voluptate
                cumque labore atque eligendi? Ex, odit! Quidem, dolorum nam?
                consectetur, adipisicing elit. Perspiciatis, maiores!
              </p>
              <h3 className="text-2xl font-semibold mb-4">Our Mission</h3>
              <p className="mb-4">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia
                deleniti deserunt soluta ipsum libero veritatis, inventore ex
                possimus pariatur doloribus voluptatum eligendi autem. Mollitia
                officiis ullam quae voluptates illo placeat.
              </p>
            </div>
          </div>
        </div>
